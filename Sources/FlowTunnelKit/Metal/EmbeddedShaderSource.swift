/// Embedded Metal shader source for star tunnel effect.
///
/// The shader source is embedded directly in Swift to avoid SPM resource bundle
/// loading issues when the package is used as a dependency in Xcode projects.
enum EmbeddedShaderSource {
    static let starTunnelShader = """
