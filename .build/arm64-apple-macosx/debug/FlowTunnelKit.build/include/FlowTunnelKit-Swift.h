...
#ifndef FLOWTUNNELKIT_SWIFT_H
#define FLOWTUNNELKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlowTunnelKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <h2>How it works</h2>
/// <h3>One-time setup (init):</h3>
/// <ol>
///   <li>
///     Gets a GPU device from the system
///   </li>
///   <li>
///     Loads the Metal shader code and compiles it via <code>ShaderLibrary</code>
///   </li>
///   <li>
...
SWIFT_CLASS("_TtC13FlowTunnelKit23MetalStarTunnelRenderer")
@interface MetalStarTunnelRenderer : NSObject <MTKViewDelegate>
